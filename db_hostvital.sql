...
(2, 'dr. Stephen Marbun, SpBS', 'Bedah Saraf', 'Rumah Sakit Siloam Simatupang', 'Senin - Rabu (10:00 - 16:00) dan Jumat (16:00 - 20:00)', 'dokter-2.png', NULL, '2021-06-05 06:21:31'),
...
(5, 2, 'Kelas 1', 'AC, 1 Bed, 1 Kamar mandi dengan air panas & dingin, Bedside cabinet, Kulkas, Kursi tunggu, Overbed Table, Meja TV, Telepon.', 1, 900000, 'kamar-3.jpg', NULL, NULL),
...
(7, 3, 'Kelas 2', 'AC, 1 Bed, 1 Kamar mandi dengan air panas & dingin, Bedside cabinet, Kulkas, Kursi tunggu, Overbed Table, Meja TV, Telepon.', 12, 900000, 'kamar-3.jpg', NULL, NULL);
...
CREATE TABLE `reservasi` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `id_kamar` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `reservasi` (`id`, `id_kamar`, `nama_wali`, `nama_pasien`, `jenis_kelamin`, `nik`, `ttl`, `alamat_pasien`, `bukti_pembayaran`, `created_at`, `updated_at`) VALUES
(67, 1, 'Alya', 'Meutia', 'perempuan', '1234567890', 'Jakarta, 1/1/2000', 'Jakarta', '26-268856_orange-dollar-sign-dollar-sign-icon-orange.png', '2021-06-12 04:00:50', '2021-06-12 04:00:50');
...
(4, 16, 'Keren', '2021-06-12 09:50:16'),
(5, 20, 'bagus', '2021-06-12 11:02:30');
...
INSERT INTO `riwayatinap` (`id_riwayat`, `id_user`, `reservasi_id`, `namars`, `tipekamar`, `harga`, `status`, `keter`) VALUES
(20, 23, 67, 'Rumah Sakit Premier Bintaro', 'Premier', 2500000, 'Approve', 'selesai');
...
INSERT INTO `riwayatobat` (`id_riwayat`, `id_user`, `namabel`, `namabat`, `jumlah`, `harga`, `total`, `status`, `ket`) VALUES
(16, 23, 'Meutia Aulia Fitri', 'Panadol Advance 100mg', 1, 30000, 30000, 'Need Approve', 'selesai');
...
INSERT INTO `transactions` (`id`, `obat_id`, `user_id`, `qty`, `total`, `nama_lengkap`, `no_telpon`, `alamat`, `metode_pembayaran`, `foto`, `status`, `created_at`, `updated_at`) VALUES
(24, 1, 23, 1, 30000, 'Meutia Aulia Fitri', '1234567890', 'Jalan Kakaktua Blok C23', 'transfer_bank', '26-268856_orange-dollar-sign-dollar-sign-icon-orange.png', 'Approve', '2021-06-12 04:10:35', '2021-06-12 04:16:23');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `role`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(23, 'Meutia', 'Aulia', 'meutia', 'USER', 'meutia@gmail.com', NULL, '$2y$10$DvK/SLK2Bhy1jXJtXN2.8u95H7wwD77/ggxvPWnvjVmlsqGDpcQXO', NULL, '2021-06-12 03:24:42', '2021-06-12 03:24:42'),
(24, 'Super', 'Admin', 'superadmin', 'ADMIN', 'superadmin@gmail.com', NULL, '$2y$10$/ZofoTIACXsY/sdcSDa6NODurlf57b8F27BjLe1VTKYAqfO90nsOK', NULL, '2021-06-12 03:28:10', '2021-06-12 03:28:10');
...
--
ALTER TABLE `riwayatinap`
  MODIFY `id_riwayat` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
