    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/updatedatauser/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div id="formStep1">
              <center>
              <h5 style="color:#CC4848">Form Edit Data User</h5>
              </center>


             
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Nama Depan</label>
                <input name="firstname" value="{{ $data->firstname }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamapasien" class="form-label">Nama Belakang</label>
                <input name="lastname" value="{{ $data->lastname }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamapasien" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputktp" class="form-label">User Name</label>
                <input name="username" value="{{ $data->username }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputktp" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputktp" class="form-label">Email</label>
                <input name="email" value="{{ $data->email }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputktp" aria-describedby="emailHelp">
              </div>
            ...
            <div class="d-grid gap-2">
                ...
                type="button">Update Data</button>
            </div>
            <br>
          </form>
        </div>
