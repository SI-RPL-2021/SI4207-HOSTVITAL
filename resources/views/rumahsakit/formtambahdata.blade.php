    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/adddatarumahsakit" method="POST" enctype="multipart/form-data">
            @csrf
            <div id="formStep1">
              <center>
              <h5 style="color:#CC4848">Input Data Rumah Sakit Baru</h5>
              </center>
              ...
              <div class="mb-3">
                ...
                <input name="website" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input name="notelp" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input name="googlemapembed" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputktp" aria-describedby="emailHelp">
              </div>
              ...
              <div class="mb-3">
                ...
                <input name="alamat" style="border: 2px solid #CC4848; border-radius:10px" type="text" placeholder="ex: Tangerang" class="form-control"
