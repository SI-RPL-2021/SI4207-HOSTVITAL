    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/updatedatadiagnosis/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
           
              <center>
              <h5 style="color:#CC4848">Update Data Diagnosis</h5>
              </center>
              ...
              <div class="mb-3">
                <label style="font-weight: bold;" class="form-label">Konten Html</label>
                    <textarea name="kontenhtml" style="border: 2px solid #CC4848; border-radius:10px" class="form-control" style="height: 100px">{{ $data->kontenhtml }}</textarea>
                <br>
              </div>
              ...
              <div class="mb-3">
                ...
                <input name="ditinjau" value="{{ $data->ditinjau }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
