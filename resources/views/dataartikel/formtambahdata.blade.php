    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/tambahdataartikel" method="POST" enctype="multipart/form-data">
            @csrf
           
              <center>
              <h5 style="color:#CC4848">Input Data Artikel</h5>
              </center>
             
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Judul</label>
                <input name="title" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input name="tag" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>

              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Author</label>
                <input name="author" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>

              <div class="mb-3">
                <label style="font-weight: bold;"  class="form-label">Content</label>
                    <textarea name="content" style="border: 2px solid #CC4848; border-radius:10px" class="form-control" style="height: 100px"></textarea>
                <br>
              </div>
