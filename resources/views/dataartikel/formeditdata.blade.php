    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/updatedataartikel/{{ $data->id }}" method="POST" enctype="multipart/form-data">
            @csrf
              <center>
              <h5 style="color:#CC4848">Update Data Artikel</h5>
              </center>
             
              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Judul</label>
                <input name="title" value="{{ $data->title }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>

              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Tag</label>
                <input name="tag" value="{{ $data->tag }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>

              <div class="mb-3">
                <label style="font-weight: bold;" for="exampleInputnamawali" class="form-label">Author</label>
                <input name="author" value="{{ $data->author }}" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
                  id="exampleInputnamawali" aria-describedby="emailHelp">
              </div>

              <div class="mb-3">
                <label style="font-weight: bold;"  class="form-label">Content</label>
                    <textarea name="content" style="border: 2px solid #CC4848; border-radius:10px" class="form-control" style="height: 100px">{{ $data->content }}</textarea>
                <br>
              </div>
              ...
              <div class="mb-3">
                ...
                <img src="{{ asset('resource/imgres/articles/'.$data->image) }}" class="d-block w-50" alt="...">
                
              </div>

            <div class="d-grid gap-2">
                <button type="submit" class="btn"  style="background-color: #CC4848; color:white; border-radius:10px;"
                type="button">Simpan Perubahan Data</button>
            </div>
            <br>
          </form>
        </div>
