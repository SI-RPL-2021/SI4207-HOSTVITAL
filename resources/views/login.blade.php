...
<body background="{{ 'resource/imgres/back-about.png' }}"
  ...
  <div class="container mb-5 pt-5 pb-5">
              <div class="row justify-content-md-center">
                  <div class="col" style="background-color: #CC4848; height: 500px; border-top-left-radius: 10px; border-bottom-left-radius: 10px;">
                  <center>
                  ...
                  <form method="post"class="" style="padding-left: 100px; padding-right: 100px; margin-top: 12%;">
                      ...
                      <div class="d-grid gap-2">
                          <button class="btn" style="background-color: #CC4848; color:white; border-radius:10px" type="submit">Login</button>
                      </div>
                      <br>
                      <center>
                      <h6 style="font-weight: normal;">Belum punya akun? Daftar <a href="{{ '/register' }}" style="color:black;">Disini</a></h6>
                      </center>
                  </form>
                </div>
            </div>
