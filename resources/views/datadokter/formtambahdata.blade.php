    ...
    <div class="container mb-5 pt-5 pb-5">
      <div class="row justify-content-md-center">
        <div class="col-8  shadow-custom" style="background-color: white;">
          <form style="padding-left: 100px; padding-right: 100px; margin-top: 10%;" action="/tambahdatadokter" method="POST" enctype="multipart/form-data">
            @csrf
            <div id="formStep1">
              <center>
              ...
              <div class="mb-3">
                ...
                <input name="spesialis" style="border: 2px solid #CC4848; border-radius:10px" type="text" class="form-control"
