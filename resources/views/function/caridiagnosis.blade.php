            ...
            <form method="get">
                <div class="row" style="width: 100%">
                    <div class="col-md-11" style="padding: 0 0 0 1rem">
                        <input name="nama_diagnosis" class="search-100" type="text" id="search-100" placeholder="Keluhan">
                    </div>
...
<div class="container">
    ...
    <div class="shadow card mb-3" style="max-width: 81rem; border-radius: 10px">
        <div class="card-body">
            ...
            <pre style="text-align:justify;white-space:pre-wrap;font-family:var(--bs-font-sans-serif);">{{$d->deskripsi}}</pre>
            <div id="button">
                <span style="float: right">
                    <a href="{{ url('/detaildiagnosis/'.$d->id) }}" class="card-link text-secondary text-right mx-auto">Lihat lebih banyak</a>
                </span>
            </div>
        </div>
    </div>
