...
<body background="{{ 'resource/imgres/back-about.png' }}"
  ...
  <li class="nav-item" style= "margin-right: 2rem; text-align:center;" >
    ...
    <br><br>
  <h4>Timothy Felixivano</h4>
  <p>timothyfelixivano@icloud.com</p>
  <button type="button" class="btn btn-danger" style="background-color: #CC4848; width:225px; border-radius:10px;">Edit Profile</button>
    </div>
  </div>
        </div>
