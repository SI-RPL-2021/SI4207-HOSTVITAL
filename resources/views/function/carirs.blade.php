                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6">
                            <div class="card-body">
                                ...
                                <a class="b-link" href="{{ '/detailrs' }}" style="font-size: 14px">Lihat Rumah Sakit</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="shadow card mb-3 pop" style="border: 0; border-radius: 10px">
                        <div class="row g-0">
                            <div class="col-md-3" style="overflow: hidden;">
                                <img src="{{ 'resource/imgres/rssiloam.png' }}" style="height: 150px;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <a class="b-link" href="#" style="font-size: 14px">Lihat Rumah Sakit</a>
                                </div>
                            </div>
                        </div>
                    </div>
