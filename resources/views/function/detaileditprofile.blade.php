    ...
    <div class="container mb-5 pt-5 pb-5">
        <div class="row shadow" style="border-radius:10px; overflow: hidden;">
            ...
            <div class="col-md-4" style="background-color: #FFFF; text-align:center; padding-top:250px">
                ...
                <br><br>
                <button type="button" class="btn btn-secondary btn-sm" style="width:225px border-radius:10px;">Ganti
                    Profile</button>
            </div>
            <div class="col-md-5" style="background-color: #FFFF; padding-right:50px">
                <br><br>

                <form action="{{ '/detaileditprofile'}}" method='post'>
                    @csrf
                    @foreach ($data as $d)
                    <input type="hidden" name="id" value="{{ $d->id}}">
                        <div class="mb-3">
                            <label style="font-weight: bold;" for="exampleInputEmail1"
                                class="form-label">Firstname</label>
                            <input style="border: 2px solid #CC4848; border-radius:10px" value="{{ $d->firstname }}"
                                type="text" name="firstname" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label style="font-weight: bold;" for="exampleInputEmail1"
                                class="form-label">Lastname</label>
                            <input style="border: 2px solid #CC4848; border-radius:10px" value="{{ $d->lastname }}"
                                type="text" name="lastname" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label style="font-weight: bold;" for="exampleInputEmail1"
                                class="form-label">Username</label>
                            <input style="border: 2px solid #CC4848; border-radius:10px" value="{{ $d->username }} "
                        ...
                        <div class="mb-3">
                            ...
                            <input style="border: 2px solid #CC4848; border-radius:10px" value="{{ $d->email }}"
                                type="email" name="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label style="font-weight: bold;" for="exampleInputPassword1"
                                class="form-label">Password</label>
                            <input style="border: 2px solid #CC4848; border-radius:10px" type="password" name="password"
                                class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label style="font-weight: bold;" for="exampleInputPassword1" class="form-label">Konfirmasi
                                Password</label>
                            <input style="border: 2px solid #CC4848; border-radius:10px" type="password"
                                name="confirmationpassword" class="form-control" id="exampleInputPassword1">
                            <br>
                        </div>
                        <br>
